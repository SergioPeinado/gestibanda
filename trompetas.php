...
$fichero='componente';
$ficheroPHP="trompetas.php";
$ficheroHTML="trompetas.html";

$TituloCabecera='Trompeteria';
$_SESSION['Fichero']=$fichero;
$ficheromayusculas=strtoupper($_SESSION['Fichero']);
$_SESSION['Titulo']="Seccion de trompeteria";
...
if($opcion=="0") {
	...
	if ($Palabra<>""){
		$sql = "SELECT * FROM $fichero WHERE banda='$IDBanda' AND seccion='trompeteria' AND nombre LIKE '%".$Palabra."%' ".$OrdenarPOR;
	}else{
		$sql = "SELECT * FROM $fichero WHERE banda='$IDBanda' AND seccion='trompeteria' ".$OrdenarPOR;
	}
