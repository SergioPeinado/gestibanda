...
$directorio = '../../uploads/'.$_SESSION['idBanda'].'/'.$_SESSION['Fichero'];
...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'          => $directorio,                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . "../". $directorio, // URL to files (REQUIRED)
			'alias'      	=> 'Documentos',
			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadAllow'   => array('image', 'text/plain', 'video', 'audio', 'application/x-gzip', 'application/pdf', 
									'application/powerpoint','application/vnd.ms-powerpoint','application/x-mspowerpoint','application/x-bzip2','application/msword','application/vnd.openxmlformats-officedocument.wordprocessingml.document',
									...
									'application/zip','application/x-compress','application/xml'),
