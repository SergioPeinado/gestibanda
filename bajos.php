...
$fichero='componente';
$ficheroPHP="bajos.php";
$ficheroHTML="bajos.html";

$TituloCabecera='Bajos';
$_SESSION['Fichero']=$fichero;
$ficheromayusculas=strtoupper($_SESSION['Fichero']);
$_SESSION['Titulo']="Seccion de bajos";
...
if($opcion=="0") {
	...
	if ($Palabra<>""){
		$sql = "SELECT * FROM $fichero WHERE banda='$IDBanda' AND AND seccion='bajos' AND nombre LIKE '%".$Palabra."%' ".$OrdenarPOR;
	}else{
		$sql = "SELECT * FROM $fichero WHERE banda='$IDBanda' AND seccion='bajos' ".$OrdenarPOR;
	}
