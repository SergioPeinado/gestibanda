            ...
            success: function(data)
            {
            	if(data)
            	{
            		...
            		if(json.res == 'full')
            		{
            			...
            			{
            				html+='<a href="#" onclick="info(\''+json.data[datos].CIF+'\',\''+json.data[datos].Nombre+'\')" class="list-group-item">';
            				html+='<h4 class="list-group-item-heading">ID:' + json.data[datos].CIF;
