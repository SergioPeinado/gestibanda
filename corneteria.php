...
$fichero='componente';
$ficheroPHP="corneteria.php";
$ficheroHTML="corneteria.html";

$TituloCabecera='Corneteria';
$_SESSION['Fichero']=$fichero;
$ficheromayusculas=strtoupper($_SESSION['Fichero']);
$_SESSION['Titulo']="Seccion de corneteria";
...
if($opcion=="0") {
	...
	if ($Palabra<>""){
		$sql = "SELECT * FROM $fichero WHERE banda='$IDBanda' AND seccion='corneteria' AND nombre LIKE '%".$Palabra."%' ".$OrdenarPOR;
	}else{
		$sql = "SELECT * FROM $fichero WHERE banda='$IDBanda' AND seccion='corneteria' ".$OrdenarPOR;
	}
